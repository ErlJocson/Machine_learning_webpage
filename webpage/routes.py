from .makePredict import heartAttackPrediction, lungCancerPrediction, titanicDataset, musicPrediction, breastCancerPrediction
...
def musicRecommendation():
    if request.method == "POST":
        ...
        data = [age, gender]
        prediction = musicPrediction(np.array([data]))
        return render_template('Machine-learning-algorithm/music-recommendation.html', title="Music Recommendation", post=prediction)
    else:
